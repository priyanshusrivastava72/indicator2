      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 w-full animate-fade-in">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-6 items-stretch max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="flex lg:hidden items-center justify-center gap-2.5 mt-3 text-gray-500 dark:text-gray-500 light:text-gray-600 font-mono text-[9px] uppercase tracking-wider select-none bg-white/5 border border-white/5 light:bg-black/5 light:border-black/5 py-2 px-4 rounded-xl self-center">
              <motion.div
                animate={{ x: [-3, 3, -3] }}
